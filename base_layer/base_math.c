...
#define VECTOR3_MAX ((Vector3){FLOAT_MAX, FLOAT_MAX, FLOAT_MAX})
...
Matrix4x4 matrix4x4_multiply(Matrix4x4 lhs, Matrix4x4 rhs){
    Matrix4x4 dst;
    float* d = dst.M;
    float* l = lhs.M;
    float* r = rhs.M;
...
Vector3 vector3_mult(Vector3 lhs, Vector3 rhs){
    lhs.x *= rhs.x;
    lhs.y *= rhs.y;
    lhs.z *= rhs.z;
    return lhs;
...
Vector2 vector2_mult(Vector2 lhs, Vector2 rhs){
    lhs.x *= rhs.x;
    lhs.y *= rhs.y;
    return lhs;
}
...
Quaternion quaternion_mult(Quaternion lhs, Quaternion rhs){
    Quaternion result;
